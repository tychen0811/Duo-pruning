...
int main(int argc, char **argv) {
  ...
  try {
    ...
    if (arg_handler.verbose) {
      std::cout <<"start call void run_ranger(const ArgumentHandler& arg_handler, std::ostream& verbose_out)\n";
      run_ranger(arg_handler, std::cout);
       std::cout <<"end call void run_ranger(const ArgumentHandler& arg_handler, std::ostream& verbose_out)\n";
    } else {
