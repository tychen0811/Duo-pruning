...
int ArgumentHandler::processArguments() {
  std::cout<<"start int ArgumentHandler::processArguments() \n";
  // short options
  ...
  std::cout<<"end int ArgumentHandler::processArguments() \n";
  return 0;
}

void ArgumentHandler::checkArguments() {
  std::cout<<"start void ArgumentHandler::checkArguments()\n";
  // required arguments
  if (file.empty()) {
  ...
  std::cout<<"end void ArgumentHandler::checkArguments()\n";
}

void ArgumentHandler::displayHelp() {
  std::cout<<"start void ArgumentHandler::displayHelp()\n";
  ...
  std::cout<<"end void ArgumentHandler::displayHelp()\n";
}

void ArgumentHandler::displayVersion() {
  std::cout<<"start void ArgumentHandler::displayVersion()\n";
  ...
  std::cout << "}" << std::endl;
  std::cout<<"end void ArgumentHandler::displayVersion()\n";
}
