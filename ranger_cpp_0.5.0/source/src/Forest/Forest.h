...
public:
  ...
  void initCpp(std::string dependent_variable_name, MemoryMode memory_mode, std::string input_file, std::string validation_file, std::string test_file, uint mtry,
      ...
      std::string case_weights_file, bool predict_all, double sample_fraction, double alpha, double minprop, bool holdout, uint prepruning,uint postpruning);
  ...
  void init(std::string dependent_variable_name, MemoryMode memory_mode, Data* input_data, Data* validation_data, Data* test_data, uint mtry,
