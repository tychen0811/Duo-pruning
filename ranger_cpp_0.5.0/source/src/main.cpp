  ...
  try {
    ...
    if (arg_handler.verbose) {
      ...
      verbose_out = logfile;
        ...
        *verbose_out << "HERE YOU GO!!"<<std::endl;
    // Call Ranger
    *verbose_out << "Starting Ranger." << std::endl;
    forest->initCpp(arg_handler.depvarname, arg_handler.memmode, arg_handler.file,arg_handler.file_validation, arg_handler.file_test, arg_handler.mtry,
        ...
        arg_handler.alpha, arg_handler.minprop, arg_handler.holdout,arg_handler.prepruning,arg_handler.postpruning);
